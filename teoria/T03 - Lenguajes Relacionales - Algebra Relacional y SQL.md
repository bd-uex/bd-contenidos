...
Se denota por $\sigma_{<condición>}(R)$ donde
	...
	- Se seleccionan las tuplas que hacen que la condición sea verdadera: aparecen en el resultado de la operación
	- Las tuplas que hacen que la condición sea falsa se filtran: descartadas del resultado de la operación
...
> Resultado:
>
>|Empleado.Nombre|Empleado.Apellido1|Empleado.Apellido2|Empleado.Dni|Empleado.FechaNac|Empleado.Direccion|Empleado.Sexo|Empleado.Sueldo|Empleado.SuperDni|Empleado.Dno|
>|---|---|---|---|---|---|---|---|---|---|
>|'Alicia'|'Jimenez'|'Celaya'|999887777|1968-05-12|'Gran Vía, 8'|'M'|25000|987654321|4|
>|'Juana'|'Sainz'|'Oreja'|987654321|1941-06-20|'Cerquillas, 67'|'M'|43000|888665555|4|
>|'Luis'|'Pajares'|'Morera'|987987987|1969-03-29|'Enebro, 90'|'H'|25000|987654321|4|
...
>|Empleado.Nombre|Empleado.Apellido1|Empleado.Apellido2|Empleado.Dni|Empleado.FechaNac|Empleado.Direccion|Empleado.Sexo|Empleado.Sueldo|Empleado.SuperDni|Empleado.Dno|
>|---|---|---|---|---|---|---|---|---|---|
>|'Alberto'|'Campos'|'Sastre'|333445555|1955-12-08|'Avda. Ríos, 9'|'H'|40000|888665555|5|
>|'Juana'|'Sainz'|'Oreja'|987654321|1941-06-20|'Cerquillas, 67'|'M'|43000|888665555|4|
>|'Fernando'|'Ojeda'|'Ordonez'|666884444|1962-09-15|'Portillo, s/n'|'H'|38000|333445555|5|
>|'Eduardo'|'Ochoa'|'Paredes'|888665555|1937-11-10|'Las Peñas, 1'|'H'|55000|null|1|
>
...
> Resultado:
> 
> |Empleado.Apellido1|Empleado.Nombre|Empleado.Sueldo|
> |---|---|---|
> |'Perez'|'Jose'|30000|
> |'Campos'|'Alberto'|40000|
> |'Jimenez'|'Alicia'|25000|
> |'Sainz'|'Juana'|43000|
...
> ```
> Resultado:
> |Empleado.Nombre|Empleado.Apellido1|Empleado.Sueldo|
> |---|---|---|
> |'Jose'|'Perez'|30000|
...
> Resultado:
> 
> |Empleado.NuevoNombre|Empleado.NuevoApellido|Empleado.NuevoSueldo|
> |---|---|---|
> |'Jose'|'Perez'|30000|
> |'Alberto'|'Campos'|40000|
> |'Fernando'|'Ojeda'|38000|
...
>[!exercise]+ Ejercicio
> 1. Devuelve los nombres y la fecha de nacimiento de todas las personas almacenadas en la base de datos, sean empleados o familiares. 
...
- Una operación especial, llamada CONCATENACIÓN, combina esta secuencia en una sola operación.
...
- En RelaX:
	- Si no se especifican atributos de agrupamiento, la relación completa es el grupo
